...
| `RATE_LIMIT_UPLOAD_PER_MINUTE` | `10` | Document **upload writes** per minute (`POST /ui/documents/upload`, `POST /api/v1/documents`). Viewing the documents page, refreshing its list, exports and tag edits use the default bucket |
