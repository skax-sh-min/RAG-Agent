...
| `SEARCH_CURATED_QA_WEIGHT` | `1.5` | 0.5 ~ 5.0 | §10.10 — curated-Q&A axis weight, applied flat like the keyword axis (not group-normalized with the vector axes) — above `1.0` so a verified answer tends to surface without dominating outright |
