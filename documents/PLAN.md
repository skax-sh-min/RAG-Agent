...
> **진행 현황 (2026-08-24)**: Phase 0 완료 · Phase 1 절반 완료.
> ✅ 0-a(enum 코어) · 0-b(성질 질의 치환) · 0-c(스타일 지시문 층 제거) · 0-d(UI L 제거) ·
> 1-a(RAG 전용 프롬프트) · 1-b(Direct 전용 프롬프트) — 버전 0.4.0-SNAPSHOT, 테스트 1,557건 통과.
> 🔵 남은 것: 0-e(`/settings` 유효 예산 표시) · 1-c(S 후처리 조건부 가드화) · 1-d(스트리밍 최종
> 답변 동기화) · Phase 2~4.
>
