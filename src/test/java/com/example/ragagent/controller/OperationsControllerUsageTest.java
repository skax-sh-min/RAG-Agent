...
class OperationsControllerUsageTest {
    ...
    void setUp() {
        ...
        when(props.llmSafe()).thenReturn(new AppProperties.LlmConfig(
                List.of(chatProvider), 2, 10, 180, "COST_FIRST", 3, 20, 0.0, 0.1, 0.0, 0.7, true, 6000, 1, true));
    ...
    private void withGhostProvider() {
        ...
        when(props.llmSafe()).thenReturn(new AppProperties.LlmConfig(
                List.of(local, ghost), 2, 10, 180, "COST_FIRST", 3, 20, 0.0, 0.1, 0.0, 0.7, true, 6000, 1, true));
    }
