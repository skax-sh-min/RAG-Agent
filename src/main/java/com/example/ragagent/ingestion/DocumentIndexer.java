...
public class DocumentIndexer {
    ...
    public DocumentInfo index(IndexRequest req) throws IOException {
        ...
        deleteExistingVectorsAndFiles(docId, req.version());
        ...
        vectorStore.add(req.version(), enriched);
        ...
        if (req.staleDocId() != null) {
            ...
            deleteArtifacts(req.staleDocId(), req.version());
        }
     ...
     */
    public SyncResult syncDirectory(String version, Path documentsDir,
    ...
    private void deleteExistingVectorsAndFiles(String docId, String version) {
        deleteExistingVectorsOnly(docId, version);
        deleteDocFiles(docId);
    }
    ...
    private void deleteDocFiles(String docId) {
